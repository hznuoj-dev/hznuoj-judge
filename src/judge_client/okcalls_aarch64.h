#ifndef OKCALLS_AARCH64_H_
#define OKCALLS_AARCH64_H_

#include "okcalls.h"

// C C++
int LANG_CV[CALL_ARRAY_SIZE] = {
    0,   48,  56,  62,  63,  64,  72,  78,  80,  94,  104, 112, 134,
    135, 160, 184, 200, 214, 216, 220, 221, 248, 152, 344, 136, 120,
    8,   40,  232, 328, 440, 424, 472, 360, 24,  456, 504, 296, 168,
    376, 382, 392, 511, 280, 488, 88,  312, 264, 408, 0};

// pascal
int LANG_PV[CALL_ARRAY_SIZE] = {29, 63, 64, 78, 94, 112, 134, 163, 220, 511, 0};

// java
int LANG_JV[CALL_ARRAY_SIZE] = {48,  56,  57,  63,  78,  79,  80,  94,
                                96,  98,  99,  112, 134, 135, 163, 172,
                                179, 214, 215, 220, 222, 226, 511, 0};
